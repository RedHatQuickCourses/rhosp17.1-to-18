...
| external    | n/a  | 172.25.250.0/24    | 172.25.250.19 - 172.25.250.100                              | n/a                         | n/a                       | n/a                      
...
|======================================================================================================================================================================================
Note: The storage network is the network used by the OCP cluster network.


From the utility host, we will be using a preconfigured set of yaml files in the `files` directory which start with `osp-ng-nncp-`. There are 3 files for worker nodes. 
