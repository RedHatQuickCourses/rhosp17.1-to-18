...
+
In the workstation terminal, clone the repo and change directory to the files that we will used later in the lab
+
[source,bash,role=execute]
----
git clone https://github.com/RedHatQuickCourses/rhosp17.1-to-18 labrepo
...
install-j6ctg   openstack-operator.v1.0.14   Manual     false
----
