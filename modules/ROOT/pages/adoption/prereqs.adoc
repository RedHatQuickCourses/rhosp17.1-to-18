...
* oc command line tool on your workstation (workstation host)
* k9s command line tool on your workstation (workstation host)
* podman command line tool on your workstation (workstation host)
...
From the workstation, access to the utility host
+
