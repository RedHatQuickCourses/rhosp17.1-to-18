...
. **Search** for the catalog entry: **Upgrade a Red Hat OpenStack Platform (RHOSP) 17.1 to Red Hat OpenStack Services on OpenShift (RHOSO) 18 using the Adoption Mechanis**.
...
. The lab environment will be ready in approximately 40-50 minutes.
